...
export class GHLEmailService {
  ...
  async sendTeamInvitation(to: string, teamName: string, inviteUrl: string): Promise<boolean> {
    const htmlBody = `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 40px 20px; text-align: center; border-radius: 8px 8px 0 0;">
          <h1 style="color: white; margin: 0; font-size: 28px;">Atlas AI Teams</h1>
        </div>
        
        <div style="background: white; padding: 40px 30px; border-radius: 0 0 8px 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          <h2 style="color: #333; margin-top: 0;">You've Been Invited to Join a Team! 🎉</h2>
          
          <p>Hi there,</p>
          
          <p>You've been invited to join the <strong>${teamName}</strong> team on Atlas AI. As a team member, you'll be able to collaborate with your team and access shared resources.</p>
          
          <h3 style="color: #667eea; margin-top: 30px;">Team Benefits:</h3>
          <ul style="line-height: 2;">
            <li>🤝 <strong>Collaborate</strong> with team members</li>
            <li>📚 <strong>Shared Knowledge Base</strong> - Access team documents and resources</li>
            <li>💬 <strong>Team Chats</strong> - Work together on AI-powered projects</li>
            <li>⚙️ <strong>Custom Settings</strong> - Team-specific AI configuration</li>
          </ul>
          
          <div style="text-align: center; margin: 30px 0;">
            <a href="${inviteUrl}" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 14px 32px; text-decoration: none; border-radius: 6px; display: inline-block; font-weight: 600;">Accept Invitation</a>
          </div>
    ...
    return this.sendEmail({
      to,
      subject: `You've been invited to join ${teamName} on Atlas AI`,
      htmlBody,
    });
  }
}
