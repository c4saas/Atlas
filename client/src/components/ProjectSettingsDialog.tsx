...
import type { Project, ProjectKnowledge } from '@shared/schema';
...
export function ProjectSettingsDialog({
  ...
  // Get max file size from capabilities or use default
  const maxFileSizeMb = getMaxFileSizeMb(capabilities);
